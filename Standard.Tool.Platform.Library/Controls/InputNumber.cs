...
using PostionEnum = Standard.Tool.Platform.Library.Enums;

namespace Standard.Tool.Platform.Library.Controls
{
    ...
    public class InputNumber : TextBox
    {
        ...
        public static readonly DependencyProperty ControlsPositionProperty =
            DependencyProperty.Register("ControlsPosition", typeof(EnumPosition), typeof(InputNumber), new PropertyMetadata(PostionEnum.EnumPosition.Strech));
